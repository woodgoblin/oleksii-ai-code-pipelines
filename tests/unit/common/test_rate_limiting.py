...
from common.rate_limiting import (
    RateLimiter,
    _extract_retry_delay,
    create_rate_limit_callbacks
)
...
class TestRetryDelayExtraction:
    ...
    def test_should_extract_delay_from_quoted_json_format(self):
        ...
        # Act
        delay = _extract_retry_delay(error_content)
    ...
    def test_should_handle_decimal_delays(self):
        """Should correctly parse decimal delay values."""
        # Arrange
        error_content = '{"retryDelay":"2.5s"}'
    ...
    def test_should_handle_malformed_json_gracefully(self):
        """Should handle malformed JSON without crashing."""
        # Arrange
        error_content = '{"retryDelay":"invalid"}'
    ...
    def test_should_handle_empty_string(self):
        """Should handle empty error content gracefully."""
        # Arrange
        error_content = ""
...
class TestRateLimitCallbacks:
    ...
    def test_should_create_callbacks_with_custom_limiter(self, mock_logger):
        ...
        pre_callback, after_callback = create_rate_limit_callbacks(
            rate_limiter_instance=custom_limiter,
